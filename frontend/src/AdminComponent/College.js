                                    ...
                                    <form class="forms-sample py-3" onSubmit={handleSubmit}>
                                        <div class='row'>
                                            <div class="form-group col-lg-3">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputUsername1" value={value.college} placeholder="College Name*" name='college' onChange={onhandleChange} />
                                                {error.college && <span className='text-danger'>{error.college}</span>}
                                            </div>
                                            <div class="form-group col-lg-3">
                                            ...
                                            <div class="form-group col-lg-3">
                                                ...
                                                <input type="contactperson" class="form-control" id="exampleInputUsername1" value={value.contactperson} placeholder="Contact Person" name='contactperson' onChange={onhandleChange} />
