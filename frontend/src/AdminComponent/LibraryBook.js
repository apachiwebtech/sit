                                    ...
                                    <form class="forms-sample py-3" onSubmit={handleSubmit}>
                                        <div class='row'>
                                            ...
                                            <div class="form-group col-lg-3">
                                                ...
                                                <input type="contactperson" class="form-control" id="exampleInputUsername1" value={value.publication} placeholder="Publication" name='publication' onChange={onhandleChange} />
                                            ...
                                            <div class="form-group col-lg-3">
                                                ...
                                                <input type="telephone" class="form-control" id="exampleInputUsername1" value={value.author} placeholder="Author" name='author' onChange={onhandleChange} />
                                                
                                            </div>
                                            <div class="form-group col-lg-3">
                                                <label for="exampleInputUsername1">Purchase Date</label>
                                                <input type="mobile" class="form-control" id="exampleInputUsername1" value={value.purchasedate} placeholder="Purchase Date" name='purchasedate' onChange={onhandleChange} />
                                                
                                            </div>

                                            <div class="form-group col-lg-3">
                                                <label for="exampleInputUsername1">Price</label>
                                                <input type="email" class="form-control" id="exampleInputUsername1" value={value.price} placeholder="Price" name='price' onChange={onhandleChange} />
                                                
                                            </div>
                                           
                                            <div class="form-group col-lg-3">
                                                <label for="exampleInputUsername1">Rack No.</label>
                                                <input type="website" class="form-control" id="exampleInputUsername1" value={value.rackno} placeholder="Rack No." name='rackno' onChange={onhandleChange} />
